...
if ($_POST[check] == 1 && !$_SESSION[wm_user][play] && Goede_Gebruikersnaam($_POST[name]))
{
...
if ($_POST[wmcheck] == 1 && $_SESSION[wm_user][play]==1)
{
...
if ($_SESSION[wm_user][play]!=1)
{
	...
	Name <input type=text name=name value="<?=($_SESSION[wm_user][name])?$_SESSION[wm_user][name]:"Anonymous"?>" maxlenght=22><br>
	<br>
