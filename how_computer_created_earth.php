...
function type_text()
{
	...
	{
		tmp_speed = get_rand_num( speed-30, speed-(-30) );
		setTimeout("type_text()", tmp_speed);
	}
}

function get_rand_num( lower, upper )
{
	if ( upper < lower )
	{
		tmp = lower;
	...
	diff = upper - lower;
	rand = Math.random()
	rand_num = Math.round(lower + rand * diff);
...
<body bgcolor="black" text="black" alink="red" vlink="#00007f" link="blue" onload="type_text()">
...
<input type="button" value="rand num" onclick="alert(get_rand_num(50,70));">
